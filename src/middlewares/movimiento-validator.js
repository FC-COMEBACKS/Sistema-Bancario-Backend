...
export const realizarTransferenciaValidator = [
  ...
  body("cuentaOrigen")
    .notEmpty()
    .withMessage("El número de cuenta de origen es obligatorio"),
  body("cuentaDestino")
    .notEmpty()
    .withMessage("El número de cuenta de destino es obligatorio"),
  body("monto")
    .notEmpty()
    ...
    .isFloat({ max: 2000 })
    .withMessage("No se puede transferir más de Q2000 por transacción"),
...
export const realizarDepositoValidator = [
  ...
  body("cuentaDestinoId")
    ...
    .isMongoId()
    .withMessage("El ID de la cuenta de destino no es válido"),
  body("monto")
    .notEmpty()
    .withMessage("El monto es obligatorio")
    .isFloat({ min: 0.01 })
...
export const getHistorialCuentaValidator = [
  validateJWT,
  hasRoles("ADMIN", "CLIENT"),
  param("cuentaId").isMongoId().withMessage("El ID de la cuenta no es válido"),
  validateField,
  handleErrors,
];